    ...
    if (sub === "request") {
      ...
      await interaction.editReply({
        embeds: [prettyEmbed({
          ...
          color: COLORS.info,
          footer: "You'll be notified when it's reviewed • Zenvy",
        })],
      });
      ...
      interaction.user.send({
        embeds: [prettyEmbed({
          ...
          color: COLORS.info,
          footer: "You'll be DM'd again when a manager reviews it • Zenvy",
        })],
      }).catch(() => {});
    ...
    // ── /loa list ─────────────────────────────────────────────────────────────
      ...
      await interaction.editReply({
        embeds: [prettyEmbed({
          ...
          color: COLORS.info,
          footer: `${loas.length} total • Zenvy`,
        })],
      });
    ...
    // ── /loa approve ──────────────────────────────────────────────────────────
      ...
      target.send({
        embeds: [prettyEmbed({
          ...
          color: COLORS.success,
          footer: "Use /loa end when you return • Zenvy",
        })],
      }).catch(() => {});
    ...
    // ── /loa deny ─────────────────────────────────────────────────────────────
      ...
      target.send({
        embeds: [prettyEmbed({
          ...
          color: COLORS.danger,
          footer: "You may submit a new request if circumstances change • Zenvy",
        })],
      }).catch(() => {});
    ...
    // ── /loa history ──────────────────────────────────────────────────────────
      ...
      await interaction.editReply({
        embeds: [prettyEmbed({
          ...
          color: COLORS.info,
          fields,
          footer: `Page ${clampedPage} of ${totalPages} • Zenvy`,
        })],
      });
    }
  },
